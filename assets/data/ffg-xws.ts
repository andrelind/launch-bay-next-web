import { Faction, SlotKey } from '../../types';
...
const t: {
  ...
  upgrades: {
    ...
    '736': 'ioncannonbatteryoffline',
    '737': 'ioncannonbattery',
    '738': 'targetingbatteryoffline',
    '739': 'targetingbattery',
    '740': 'ordnancetubesoffline',
    '741': 'ordnancetubes',
    '742': 'pointdefensebatteryoffline',
    '743': 'pointdefensebattery',
    '744': 'turbolaserbatteryoffline',
    ...
    '870': 'alpha3bbesh',
    '871': 'alpha3eesk',
    '872': 'interceptboosterdetached',
    '873': 'interceptboosterattached',
  ...
  translations: [
    ...
    { ffg: '<boost>', xws: '[Boost]' },
    { ffg: '<focus>', xws: '[Focus]' },
    { ffg: '<crit>', xws: '[Critical Hit]' },
    { ffg: '<targetlock>', xws: '[Lock]' },
    { ffg: '<barrelroll>', xws: '[Barrel Roll]' },
    { ffg: '<frontarc>', xws: '[Front Arc]' },
    { ffg: '<turret>', xws: '[Turret]' },
    { ffg: '<turretarc>', xws: '[Single Turret Arc]' },
    { ffg: '<reararc>', xws: '[Rear Arc]' },
    { ffg: '<forcecharge>', xws: '[Force]' },
    { ffg: '<coordinate>', xws: '[Coordinate]' },
    { ffg: '<cannon>', xws: '[Cannon]' },
    { ffg: '<calculate>', xws: '[Calculate]' },
    { ffg: '<bullseye>', xws: '[Bullseye Arc]' },
    { ffg: '<standardcharge>', xws: '[Charge]' },
    { ffg: '<reload>', xws: '[Reload]' },
    { ffg: '<rotate>', xws: '[Rotate Arc]' },
    { ffg: '<straight>', xws: '[Straight]' },
    { ffg: '<leftbank>', xws: '[Bank Left]' },
    { ffg: '<rightbank>', xws: '[Bank Right]' },
    { ffg: '<leftturn>', xws: '[Turn Left]' },
    { ffg: '<rightturn>', xws: '[Turn Right]' },
    { ffg: '<torpedo>', xws: '[Torpedo]' },
    { ffg: '<missile>', xws: '[Missile]' },
    { ffg: '<config>', xws: '[Configuration]' },
    { ffg: '<evade>', xws: '[Evade]' },
    { ffg: '<cloak>', xws: '[Cloak]' },
    { ffg: '<slam>', xws: '[Slam]' },
    { ffg: '<reinforce>', xws: '[Reinforce]' },
    { ffg: '<rightsloop>', xws: "[Segnor's Loop Right]" },
    { ffg: '<leftsloop>', xws: "[Segnor's Loop Left]" },
    { ffg: '<lefttalon>', xws: '[Tallon Roll Left]' },
    { ffg: '<righttalon>', xws: '[Tallon Roll Right]' },
    { ffg: '<kturn>', xws: '[Koiogran Turn]' },
    { ffg: '<stop>', xws: '[Stationary]' },
    { ffg: '<fullfront>', xws: '[Full Front Arc]' },
    { ffg: '<fullrear>', xws: '[Full Rear Arc]' },
    { ffg: '<illicit>', xws: '[Illicit]' },
    { ffg: '<bomb>', xws: '[Device]' },
    { ffg: '<crew>', xws: '[Crew]' },
    { ffg: '<gunner>', xws: '[Gunner]' },
    { ffg: '<sensor>', xws: '[Sensor]' },
    { ffg: '<astro>', xws: '[Astromech]' },
    { ffg: '<mod>', xws: '[Modification]' },
    { ffg: '<talent>', xws: '[Talent]' },
    { ffg: '<leftarc>', xws: '[Left Arc]' },
    { ffg: '<rightarc>', xws: '[Right Arc]' },
  ],
};
