...
const conditions: Condition[] = [
  ...
  },
  {
    ...
    ability:
      "Setup: Start in reserve.\nWhen you deploy, you are placed within range 1 of any table edge and beyond range 3 of any enemy ship.\nAt the start of the round, if all of the friendly GA-97's Icon charge are active, you must deploy. Then remove this card.\nAfter a friendly GA-97 is destroyed, you must deploy. Then gain 1 disarm token and remove this card.",
    xws: 'itstheresistance'
  },
  {
    name: 'Compromising Intel',
    ability:
      'During the System Phase, if the enemy Vi Moradi is at range 0-3, flip your dial faceup.\n\nWhile you defend or perform an attack against the enemy Vi Moradi, you cannot spend focus tokens.',
